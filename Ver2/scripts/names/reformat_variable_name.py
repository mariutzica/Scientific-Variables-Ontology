    ...
    with open(csn_dst_file,'w') as dst_f:
        for variable in f:
            ...
            variable = variable.replace('soil_horizon~','soil-horizon-')\
                        .replace('__atterberg_liquid_limit','~atterberg-liquid-limit_')\
                        .replace('__atterberg_plastic_limit','~atterberg-plastic-limit_')\
                        .replace('__atterberg_shrinkage_limit','~atterberg-shrinkage-limit_')\
            ...
            variable = variable.replace('top_speed','max_of_speed')\
                            ...
                            .replace('kinetic_energy_plus_potential_energy','sum_of_kinetic_energy_and_potential_energy')\
            ...
            variable = variable.replace('antoine_vapor_pressure','antoine-vapor-pressure')\
                            ...
                            .replace('atomic_mass_constant','atomic-mass_constant')\
