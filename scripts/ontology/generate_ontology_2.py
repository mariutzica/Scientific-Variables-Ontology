    ...
    if (phen_link != '') and individuals[phen_link] not in individuals.individuals():
        ...
        if '~' in phen_link and attr_on:
            ...
            if not twophen:
                ...
                multiphen = phen_link.split('-and-')
                multiphen = [p.strip('()') for p in multiphen]
                for p in multiphen:
                    #print(f'Adding {p} to {individuals}.')
        ...
        with individuals:
            if category == 'phenomenon':
                ...
                if multiphen:
                    for p in multiphen:
                       phen_individual.has_phenomenon.append(individuals[p]) 
    ...
    with phenomenon_individuals:
        ...
        for idx, relationship in enumerate(rel_list):
            ...
            if phen_link:
                ...
                if idx in [0,1,2]:
                    phen_individual.has_primary_participant_phenomenon = [element]
                elif idx == 3:
                    phen_individual.has_adjacent_participant_phenomenon = [element]
                elif idx == 4:
                    ...
                    phen_individual.has_medium_participant_phenomenon = [element]
                elif idx == 7:
                    phen_individual.has_sink_participant_phenomenon = [element]
                elif idx == 8:
                    phen_individual.has_source_participant_phenomenon = [element]
                elif idx == 9:
                    phen_individual.has_in_participant_phenomenon = [element]
                elif idx == 10:
                    phen_individual.has_numerator_participant_phenomenon = [element]
                elif idx == 11:
                    phen_individual.has_denominator_participant_phenomenon = [element]
                elif idx == 12:
                    phen_individual.has_minuend_participant_phenomenon = [element]
                elif idx == 13:
                    phen_individual.has_subtrahend_participant_phenomenon = [element]
                elif idx == 14:
                    phen_individual.has_perspective_participant_phenomenon = [element]
                elif idx == 15:
                    phen_individual.has_source_phenomenon = [element]
                elif idx == 16:
                    phen_individual.has_sink_phenomenon = [element]
                elif idx == 17:
                    phen_individual.has_containing_phenomenon = [element]
                elif idx == 18:
                    phen_individual.has_containing_medium_phenomenon = [element]
                elif idx == 19:
                    phen_individual.is_part_of_containing_phenomenon = [element]
                elif idx == 20:
                    phen_individual.has_location = [element]
                elif idx == 21:
                    phen_individual.has_location_of_origin = [element]
                elif idx == 22:
                    phen_individual.has_location_within_model = [element]
                elif idx == 23:
                    phen_individual.has_observing_phenomenon = [element]
                elif idx == 24:
                    phen_individual.has_measurement_reference_at = [element]
                elif idx == 25:
                    phen_individual.has_measurement_reference_above = [element]
                elif idx == 26:
                    phen_individual.has_measurement_reference_since = [element]
                elif idx == 27:
                    phen_individual.has_measurement_reference_along = [element]
                elif idx == 28:
                    phen_individual.has_measurement_reference_from = [element]
                elif idx == 29:
                    phen_individual.has_measurement_reference_to = [element]
                elif idx == 30:
                    phen_individual.has_measurement_reference_below = [element]
                elif idx == 31:
                    phen_individual.has_measurement_reference_wrt = [element]
                elif idx == 32:
                    phen_individual.has_phenomenon.append(element)
                elif idx == 33:
                    phen_individual.surrounds = [element]  
                elif idx == 34:
                    phen_individual.drives = [element]
                elif idx == 35:
                    phen_individual.orbits = [element]
                elif idx == 36:
                    phen_individual.has_participating_medium_phenomenon = [element]
                elif idx == 37:
                    phen_individual.has_participating_primary_phenomenon = [element]
                elif idx in [38,39]:
                    phen_individual.undergoes_process = [element]
                elif idx in [40,41]:
                    phen_individual.has_part = [element]
                elif idx == 42:
                    phen_individual.has_abstraction = [element]
                elif idx == 43:
                    ...
                    phen_individual.has_form = [element]
                elif idx == 48:
                    phen_individual.has_role = [element]
                elif idx == 49:
                    phen_individual.has_trajectory = [element]
                elif idx == 50:
                    phen_individual.has_domain = [element]
                elif idx == 51:
                    phen_individual.is_reference_for_property = [element]
                elif idx == 52:
                    phen_individual.has_reference_for_property = [element]
                ...
                with phenomenon_individuals:
                    ...
                    if matter_individuals[object_root] in matter_individuals.individuals():
                        if matter_individuals[object_name] not in matter_individuals.individuals():
                            add_phen_link(object_name, matter_individuals, object_info, category = 'matter')
                        phen_individual.has_matter = [matter_individuals[object_name]]
                        #print('Found in matter.')
                        ...
                        if process_individuals[object_name] not in process_individuals.individuals():
                            add_phen_link(object_name, process_individuals, object_info, category = 'process')
                        phen_individual.has_process = [process_individuals[object_name]]
                        #print('Found in process.')
                        ...
                        if abstraction_individuals[object_name] not in abstraction_individuals.individuals():
                            add_phen_link(object_name, abstraction_individuals, object_info, category = 'abstraction')
                        phen_individual.has_abstraction = [abstraction_individuals[object_name]]
                        #print('Found in abstraction.')
                        ...
                        if role_individuals[object_name] not in role_individuals.individuals():
                            add_phen_link(object_name, role_individuals, object_info, category = 'role')
                        phen_individual.has_role = [role_individuals[object_name]]
                        #print('Found in role.')
                    elif phenomenon_individuals[object_root] in phenomenon_individuals.individuals():
                        if phenomenon_individuals[object_name] not in phenomenon_individuals.individuals():
                            add_phen_link(object_name, phenomenon_individuals, object_info, category = 'phenomenon')
                        phen_individual.has_phenomenon = [phenomenon_individuals[object_name]]
                        #print('Found in phenomenon.')
