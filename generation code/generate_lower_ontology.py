...
trajectory_direction_ttl = open( ext_output + 'trajectorydirection/svo-lower-trajectorydirection.ttl', 'w' )
...
convert_graph(ext_output+'trajectorydirection/svo-lower-trajectorydirection.ttl')
